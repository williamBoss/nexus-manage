...
import com.nexus.common.utils.sign.Base64;
...
public class CaptchaController {
	...
	public CaptchaController(DefaultProperties defaultProperties, ISysConfigService configService,
	...
	public AjaxResult getCode(HttpServletResponse response) throws IOException {
		...
		// 生成验证码
		String captchaType = defaultProperties.getCaptchaType();
