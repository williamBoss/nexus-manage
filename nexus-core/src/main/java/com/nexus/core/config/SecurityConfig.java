...
import com.nexus.core.security.filter.JwtAuthenticationTokenFilter;
import com.nexus.core.security.handle.AuthenticationEntryPointImpl;
import com.nexus.core.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig {
	...
	public SecurityConfig(AuthenticationEntryPointImpl unauthorizedHandler,
		...
		CorsFilter corsFilter, PermitAllUrlConfig permitAllUrl) {
