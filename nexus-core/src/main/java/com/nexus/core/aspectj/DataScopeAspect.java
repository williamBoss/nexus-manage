package com.nexus.core.aspectj;
...
import com.nexus.core.security.context.PermissionContextHolder;
...
public class DataScopeAspect {
	...
	public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias,
		...
		user.getRoles().forEach(role -> {
			if (DATA_SCOPE_CUSTOM.equals(role.getDataScope()) && Strings.CS.equals(role.getStatus(),
		...
		for (SysRole role : user.getRoles()) {
			...
			if (conditions.contains(dataScope) || Strings.CS.equals(role.getStatus(), UserConstants.ROLE_DISABLE)) {
				continue;
			}
