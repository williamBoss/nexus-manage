...
import com.nexus.common.enums.BusinessStatus;
import com.nexus.common.enums.HttpMethod;
import com.nexus.common.utils.ExceptionUtil;
...
import com.nexus.core.filter.PropertyPreExcludeFilter;
...
public class LogAspect {
	...
	private void setRequestValue(JoinPoint joinPoint, SysOperLog operLog, String[] excludeParamNames) throws Exception {
		...
		if (StringUtils.isEmpty(paramsMap) && Strings.CS.equalsAny(requestMethod, HttpMethod.PUT.name(),
