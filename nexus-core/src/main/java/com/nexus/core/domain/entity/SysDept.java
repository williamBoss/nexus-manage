...
public class SysDept extends BaseEntity {
	...
	public TreeSelect toTreeSelect() {
		List<TreeSelect> childrenTree =
			children != null ? children.stream().map(SysDept::toTreeSelect).toList() : List.of();

		return new TreeSelect().setId(deptId)
			.setLabel(deptName)
			.setDisabled(StringUtils.equals(UserConstants.DEPT_DISABLE, status))
